...
<p class="warning">
暂停一下。我想要强调一点，我们在这里的讨论并不是个无限制的建议，我们并不建议你用无值风格来编写你所有的函数式代码。当你适度的使用它时，这的确是一种可以提高可读性的技术。但就像软件开发中的大多数事情一样，也存在着滥用它的可能性。如果因为你苦苦思索的无值风格代码让你的代码变得更加难以理解，那么请停止这么做吧。用一些聪明但却深奥的办法来从代码中删除另一些“point”，你并不会因此而获得荣誉。
</p>
